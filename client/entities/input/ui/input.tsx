...
const Input: React.FC<InputProps> = ({ initialValue, type, placeholder, getText, className, label, readonly, required }) => {
    ...
    return (
        <div className={className}>
            ...
            <div className={'input-group '}>
                ...
                {
                    type === 'password' &&
                    <button type='button' onClick={() => setVisible(!isVisible)} className=" input-group-text" id="basic-addon1">
                        {
                            isVisible ?
                                ...
                                : <svg xmlns="http://www.w3.org/2000/svg" width="24x" height="24px" viewBox="0 0 24 24" fill="none">
